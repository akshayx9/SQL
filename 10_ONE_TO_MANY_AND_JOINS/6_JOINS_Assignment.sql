-- Write a schema where there are two tables - students and papers
...
-- Print first_name, title, grade with use of a join
...
-- Print if the grade is passing or failing
